...
class BranchResourceTest {
    ...
    void testGetById() {
        ...
        Branch user1 = given().when().get("/users/1").then().statusCode(200).extract().body().as(Branch.class);
        Branch user2 = given().when().get("/users/2").then().statusCode(200).extract().body().as(Branch.class);
        Branch user1Bis = given().when().get("/users/1").then().statusCode(200).extract().body().as(Branch.class);
    ...
    @Test
    void testAddUser() {
        List<Branch> users = given().when().get("/users/all").then().statusCode(200).extract().body().jsonPath().getList(".");
